...
Cuando arranques RStudio, verás que se abreve una ventana que se aparece a la de esta imagen (el fondo será blanco y no negro —ya llegará el momento de _tunearlo_—):
...
Se estará un buen rato, depende de tu conexión a internet, mostrándote un motón de información en la consola.


```{r echo=F, fig.cap="Al instalar la librería stylo —que no nececistas por ahora— instaló seis librarías más que necesita. Al final informa de que todo ha ido bien", message=FALSE, warning=FALSE, fig.align="center", out.width='75%'}
