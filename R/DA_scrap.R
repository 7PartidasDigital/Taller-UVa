...
# The trick is to analyze the URL that the on line app gives for
...
# This instruction builds the series of numbers between 0 and 69422
...
# after 1. So, as or last number is five digits long, all numbers must have four, three,
